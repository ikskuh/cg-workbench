...
bool ImGui_ImplSdlGL3_CreateDeviceObjects()
{
    ...
    g_AttribLocationPosition = 0; //glGetAttribLocation(g_ShaderHandle, "Position");
    g_AttribLocationUV = 1;       //glGetAttribLocation(g_ShaderHandle, "UV");
    g_AttribLocationColor = 2;    //glGetAttribLocation(g_ShaderHandle, "Color");
...
bool ImGui_ImplSdlGL3_Init(SDL_Window *window)
{
    ...
    // io.RenderDrawListFn = ImGui_ImplSdlGL3_RenderDrawLists;   // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.

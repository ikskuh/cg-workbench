...
REGISTER_WINDOW_CLASS(VectorSplitter, Menu::Arithmetic, "vector-splitter", "Vector Splitter");
REGISTER_WINDOW_CLASS(VectorMerger, Menu::Arithmetic, "vector-merger", "Vector Merger");
